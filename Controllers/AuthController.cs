...
namespace WebApp.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        {
            User user = db.Users.Where(a => a.Name == userDto.Name && a.Password == userDto.Password).Include(u => u.CurrentOrganization).FirstOrDefault();
        ...
        private IActionResult CreateToken(User user)
        {
            ...
            return Ok(new
            {
                Id = user.ID,
                Username = user.Name,
                Organization = user.CurrentOrganization.Title,
                Token = tokenString
            });
        }
